                            ...
                            if(isset($_GET['karjonne'])){
                                ...
                                if($res){
                                    while($rr=$res->fetch_assoc()){
                                        if($id1==$rr['name']  && $id2==$rr['amike']){ ?>
                                            <p style="background-color:#101924; "   class="float-right mt-2"><?php echo $rr['msz']?></p>
                                        <?php }else{?>
                                           <p style="background-color:#798BFF; " class="float-left mt-2"><?php echo $rr['msz']?></p>
                                       <?php }
                                    }
                                }
                            }
