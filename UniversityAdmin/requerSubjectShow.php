        ...
        <tbody>
            ...
            <?php
                ...
                <tr>
                    ...
                    <td>
                        <a href="?id=<?php echo $r['subjectId']?>" class="btn btn-danger mb-1 w-100"><i class="fas fa-trash-alt"></i> Delete</a>
                        <a href="?id=<?php echo $r['subjectId']?>" class="btn btn-warning mb-1 w-100"><i class="far fa-edit"></i> Edit</a>
                    </td>
                </tr>
                <?php }}?>
        </tbody>
